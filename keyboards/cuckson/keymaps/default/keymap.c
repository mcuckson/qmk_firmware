...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	KEYMAP(
		...
		KC_NO, KC_NO, KC_LGUI, LT(1,KC_NO),LT(1,KC_NO), KC_RGUI, KC_NO, KC_NO,  
		KC_LGUI, KC_TAB, KC_BSPC, KC_LCTL, KC_LALT, KC_NO, KC_NO, KC_RALT, KC_LCTL, KC_SPC, KC_ENT, KC_RGUI),
	KEYMAP(
		...
		KC_NO, KC_LPRN, KC_LBRC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RBRC, KC_LPRN, KC_NO)
};
